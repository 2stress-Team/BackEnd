			...
			.then(userToRemove => {
				...
				userRepository
					...
					.then(result => {
						...
						const data: Mail = {
							from: '2stress <2stress@2stressTeam.org>',
							to: userToRemove.email.toString(),
							subject: 'Unsubscription',
							text: `Hey ${userToRemove.email}! We are worried to confirm that your account has been successfully deleted. We hope to see you back soon!`,
						};
